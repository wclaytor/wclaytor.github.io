...
## Panel Members (Go-Live Focus)

### 1. **BOFH (Bastard Operator From Hell)** - Security & Infrastructure
...
### 2. **Martin Fowler** - Code Quality & Technical Debt
...
### 3. **Kent Beck** - Testing & Quality Assurance
...
### 4. **Jakob Nielsen** - Usability Red Flags
...
### 5. **Steve Krug** - First Impression & Clarity
...
Each panelist conducts a focused review:
...
## Critical Questions Each Panelist Must Answer
...
Example:
```
Please convene the go-live assessment panel for:
...
*Assessment panel personas available in: `.github/personas/`*
