...
- Happy to relocate within the US for a hybrid role for the right location and opportunity


## Links

- Personal Website: https://wclaytor.github.io/
- GitHub: https://github.com/wclaytor
- LinkedIn: https://www.linkedin.com/in/billclaytor/

## Summary

I am a Senior Software Engineer with 25 years of industry experience in software development, test automation, and quality assurance. I specialize in building AI-assisted QA workflows and leading globally distributed teams through complex testing initiatives.

## Specialties

### Software Development

Certified in Java and .NET web development, with experience in Ruby, JavaScript, and Python leveraging GenAI tools and cloud platforms.
...
**As Senior Automation QA Engineer:**

- Developed, maintained, and executed automated test suites using an in-house C# and Selenium framework, performing release verification testing for sprint deployments through Azure pipeline-based execution
- Built an AI-assisted QA workflow using GitHub Copilot in VS Code with PowerShell to automate Jira/Xray API interactions, establishing an end-to-end process for requirements analysis, test planning, test execution, and reporting
- Created an AI-assisted documentation pipeline to convert legacy training videos for the test automation framework into an up-to-date documentation library using GitHub Copilot, PowerShell, and ffmpeg for automated timestamp-based screenshot extraction
- Coordinated sprintly test report generation and delivery across seven globally distributed teams, establishing a customer-facing reporting process to convert internal test artifacts into sanitized reports delivered with each release
- Performed extensive automated and manual testing for cloud migration initiatives, coordinating with Cloud Support and Development to resolve issues during migrations from legacy datacenter environments to Azure

**As QA Lead:**

- Participated in weekly engineering leadership meetings to facilitate cross-team coordination between onshore and offshore teams
- Hired and coordinated with the India-based QA lead through weekly meetings and daily correspondence to establish and support QA processes across distributed teams
- Conducted QA automation training sessions for manual testers transitioning to automation, guiding them through Azure-based test execution, local execution in Visual Studio, and troubleshooting test failures
- Led the Automation Guild with monthly sessions on UI and performance testing topics, backlog grooming, and issue review and troubleshooting

**Leading Cross-Functional Initiatives:**

- Led the globally distributed QA DR test team through all stages of disaster recovery testing including test planning and coordinated execution, working with Production Support and Engineering to verify DR environments for multiple products across multiple iterations
- Led the performance testing pilot project, working with performance engineers to establish a JMeter and Grafana-based testing framework and core test suite, and participated in hiring the principal performance engineer
- Collaborated with the Security Guild to create a QA security testing strategy based on OWASP top 10 vulnerabilities, developing a training program based on LinkedIn Learning courses and OWASP resources
...
- Improved my knowledge of Ruby on Rails by developing an application to organize the chords and lyrics for cover songs into setlists for live performance
...
- Deployed multiple Rails application to a production environment using Dokku
...
### Senior QA Engineer and QA Manager
...
- Led the effort to evaluate multiple JavaScript-based automation frameworks to integrate test automation into JavaScript projects
...
American Public University System (APUS) is an online university system with its headquarters in Charles Town, West Virginia.

- Planned the QA Automation team schedule based on project timelines and resource availability
- Led the recruiting effort for the QA Automation Engineer and QA Automation Specialist positions
...
- Test management tools (10+ years)
