...
class HomePage(BasePage):
    ...
    def get_expertise_areas(self) -> list[str]:
        ...
        headings = cards.locator(self._EXPERTISE_HEADING)
    ...
    def get_featured_project_titles(self) -> list[str]:
        ...
        cards = self.page.locator(
            f"{self._PROJECTS_SECTION} > .container > .row .card:not(.experiment-card)")
    ...
    def click_project_by_title(self, title: str) -> None:
        ...
        """
        card_title = self.page.locator(
            f"{self._PROJECT_CARD_TITLE}:has-text('{title}')")
        card_title.click()
    ...
    def click_project_view_button(self, title: str) -> None:
        ...
        card = self.page.locator(
            f".card:has({self._PROJECT_CARD_TITLE}:has-text('{title}'))")
        card.locator(
            "a:has-text('View Project'), a:has-text('Launch')").first.click()
